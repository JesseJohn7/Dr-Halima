    ...
    <>
      ...
      >
        ...
        <div className="relative flex items-center justify-between h-[80px] px-6 md:px-14 lg:px-20 xl:px-28 max-w-7xl mx-auto">
          ...
          >
            <span
              className={`block h-[1.5px] w-[18px] bg-[#A3762E] rounded-full transition-all duration-300 origin-center ${
                menuOpen ? "rotate-45 translate-y-[6.5px]" : ""
              }`}
            />
            <span
              className={`block h-[1.5px] w-3 bg-[#A3762E] rounded-full transition-all duration-300 ${
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle, #A3762E 1px, transparent 1px)",
